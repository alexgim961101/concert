...
class ReservationControllerE2ETest extends AbstractIntegrationTest {
        ...
        void setUp() {
                ...
                // Redis 기반 토큰 생성
                QueueToken queueToken = new QueueToken(userId, concert.getId(), LocalDateTime.now().plusMinutes(30));
                queueToken.activate();
